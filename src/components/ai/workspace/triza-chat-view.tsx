...
export function TrizaChatView() {
  ...
  // ---- Render ----
  return (
    <div className="relative flex h-screen w-full overflow-hidden bg-[#0a0a0b] text-zinc-100 antialiased">
      {/* Back to Marketo home — floating top-left so users can return to the landing page */}
      <button
        onClick={() => useMarketplaceStore.getState().setCurrentView('landing')}
