...
const SESSION_KEY = 'thiora-feedback-session'
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-20 right-6 z-50 flex flex-col overflow-hidden rounded-2xl border border-border bg-background shadow-2xl md:bottom-6"
            style={{
