      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Be among the first to sell on Marketo. Create your shop, list your products and services, and start earning today.
          </p>
        </motion.div>
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-muted-foreground">
              Whether you&apos;re selling digital products, offering freelance services, or shipping physical goods — Marketo gives you everything you need to succeed. Secure escrow payments, powerful analytics, and zero withdrawal fees.
            </p>
            <Button
              size="lg"
