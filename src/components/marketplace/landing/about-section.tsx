      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
            TRIZA is an all-in-one modern marketplace where users can join as buyers, sellers, or both. Sellers can offer freelance services, sell digital and physical products, and create their own customizable online shop with a unique public URL. Buyers can easily hire freelancers and purchase products through a simple and secure system.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="relative z-10 p-8 sm:p-12 lg:p-16 text-center">
            ...
            >
              Our motive is to build a simple and powerful marketplace where people can buy, sell, and work online easily. TRIZA also supports freelancers by giving them a platform to offer services, find clients, and earn independently. It is designed to help individuals and small businesses grow and succeed in one trusted digital space.
            </motion.p>
