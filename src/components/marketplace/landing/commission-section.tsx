        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed max-w-lg mx-auto lg:mx-0">
              Unlike other platforms that take 20-30% of your hard-earned money, Marketo believes 
          ...
          >
            <div className="bg-white dark:bg-card rounded-3xl p-8 shadow-2xl shadow-violet-500/5 border border-border/50">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-sm text-muted-foreground">See how much more you earn with Marketo</p>
              </div>
