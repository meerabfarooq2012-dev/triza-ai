    ...
    return (
      ...
      >
        <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-amber-200 bg-gradient-to-b from-amber-50/50 to-transparent py-20">
          ...
          <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Your Wishlist is Empty</h3>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100">My Wishlist</h1>
