...
export const countryCodeData: CountryCode[] = [
  ...
  { name: 'Congo DR', code: 'CD', dial_code: '+243', flag: '🇨🇩' },
  ...
  { name: 'Curaçao', code: 'CW', dial_code: '+599', flag: '🇨🇼' },
  ...
  { name: 'Korea North', code: 'KP', dial_code: '+850', flag: '🇰🇵' },
  { name: 'Korea South', code: 'KR', dial_code: '+82', flag: '🇰🇷' },
  ...
  { name: 'Réunion', code: 'RE', dial_code: '+262', flag: '🇷🇪' },
