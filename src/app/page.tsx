...
const TrizaChatView = dynamic(
  withChunkRetry(() => import('@/components/ai/workspace/triza-chat-view').then(m => ({ default: m.TrizaChatView })), 'TrizaChatView'),
  { ssr: false, loading: () => <PageLoader /> }
)
